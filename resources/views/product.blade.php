...
<div class="container">
    ...
    <div class="row py-lg-5">
            ...
            <div class="carousel-inner">
                @foreach($sliders as $key => $slider)
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        <img src="{{ Storage::url($slider->image) }}" class="d-block w-100" alt="Slider Image" style="height: 500px; object-fit: cover;">
                    </div>
                @endforeach
            </div>
        ...
        <div class="album py-5 bg-body-tertiary">
            ...
            <center><a href="{{route('more.product')}}"><button class="btn btn-success">More Product</button></center>
        </div>
