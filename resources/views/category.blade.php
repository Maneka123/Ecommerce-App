      ...
      <div class="row">
        <div class="col-md-2">
            ...
            @foreach($subcategories as $subcategory)
              ...
              @if(isset($filterSubcategories)) {{in_array($subcategory->id,$filterSubcategories)?'checked  ="checked"' :''}}@endif>{{$subcategory->name}}</p>
            @endforeach
           <!--end foreach-->
...
<input type="hidden" name="categoryId" value="{{$category->id}}"><br><br>
