...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <!-- <td><form action="{{route('cart.update',$product['id'])}}" method="post">@csrf
        <input disabled="" type="text" name="qty" value="{{$product['qty']}}">
           <button class="btn btn-secondary btn-sm">
          <i class="fas fa-sync"></i>Update</button> 
          </form> -->
      </td>

      <!-- <td><form action="{{route('cart.remove',$product['id'])}}" method="post">@csrf
...
var stripe = Stripe('pk_test_51RtP5ML2jod0iOPjeoXQbtRxbt3aig4cHdo89tTzj4IjX4Rfr5wukssupJU5v9ir7frY7BpPE5gak8yUeHHku81Z008UclkREr');
