...
public function allProduct($name, Request $request)
{
    ...
    $filterSubcategories = null; // Initialize variable to avoid undefined error
    ...
    if ($request->subcategory) {
        ...
        // optionally return here only if needed
        // return $filterSubcategories;
    ...
    return view('category', compact('products', 'subcategories', 'slug', 'filterSubcategories','categoryId','category'));//mistake
}
...
public function filterProducts(Request $request){
    ...
    $subcategory=Subcategory::whereIn('id',$request->subcategory)->get(); //spelling
